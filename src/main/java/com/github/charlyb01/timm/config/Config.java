...
public class Config {
    ...
    static {
        ...
        FADE_DELAY = builder
                .comment("Fade delay (in seconds)")
                .defineInRange("fadeDelay", 3, 0, 15);

        FADE_DURATION = builder
                .comment("Fade duration (in seconds)")
                .defineInRange("fadeDuration", 5, 0, 10);
        ...
        PRINT_ON_SKIP = builder
                ...
                .define("printOnSkip", false);

        ENABLE_STRUCTURE_MUSIC = builder
                .comment("Enable structure music")
                .define("enableStructureMusic", true);

        STRUCTURE_FADE_OUT = builder
                .comment("Structure fade out mode")
